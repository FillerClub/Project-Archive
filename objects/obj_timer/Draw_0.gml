...
var str = string((team == "friendly")?global.player_turns:global.opponent_turns);
...
//draw_text_transformed((team == "friendly")?x+20:x-20,y,string((team == "friendly")?global.player_turns:global.opponent_turns),1,1,0);
