/// @description Draws part of a circle, like a pie [NOT MINE]
/// @function scr_draw_circle_part(x,y,radius,front_colour,back_colour,rotation,flip,startangle,endangle,alpha)

function scr_draw_circle_part() {
