...
#macro SAVEOBJECTVARIABLES ["x","y","z","timer","move_cooldown_timer","hp","hp_max","grid_pos","cooldown","object_index","depth","team","effects_array","effects_timer","effects_management_array","invincible","dmg","x_vel","y_vel","y_spd_max","y_spd","starting_sequence_pos","starting_sequence","shooting","accel","resource_timer","identity"]
