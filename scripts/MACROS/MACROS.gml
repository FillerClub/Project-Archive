...
#macro SAVEOBJECTVARIABLES ["x","y","z","image_xscale","image_yscale","timer","move_cooldown_timer","hp","hp_max","piece_on_grid","grid_pos","cooldown","object_index","depth","team","effects_array","effects_timer","effects_management_array","invincible","dmg","x_vel","y_vel","y_spd_max","y_spd","starting_sequence_pos","starting_sequence","shooting","accel","resource_timer","identity","tag"]
