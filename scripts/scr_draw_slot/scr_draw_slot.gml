function draw_slot(slot_index,col,textcol,cost,slot_frame = spr_slot_frame, xoffset = 0, yoffset = 0) {
	...
	//draw slot frame
	draw_sprite_ext(slot_frame,image_index,x +xoffset,y +yoffset,1,1,0,col,1);
	...
	draw_text_transformed(x +37,y +58,string(cost),1,1,0);
