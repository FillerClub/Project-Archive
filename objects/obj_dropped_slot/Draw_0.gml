...
draw_set_halign(fa_center); draw_set_valign(fa_middle); draw_set_color(c_black) draw_set_font(fnt_bit);
draw_text_transformed(x +41,y +57 ,string(cost),1,1,0);
draw_set_color(c_white) draw_set_font(fnt_basic);
